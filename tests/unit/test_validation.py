...
# Scenariusz: pusta lista zaznaczonych pozycji.
...
#   Scenariusz: poprawne elementy, ale z duplikatem.
...
# Scenariusz: 'checked' nie jest listą (np. string).
...
# Scenariusz: element na liście nie jest stringiem (np. int).
...
# Scenariusz: lista zawiera element spoza dozwolonego zbioru (whitelisty).
...
# Scenariusz: duży ładunek (wiele elementów), nawet jeśli to duplikaty.
...
# Scenariusz: Użycie wrappera przyjmującego „gołą” listę.
# Oczekiwanie: zwrócona lista bez duplikatów, z zachowaniem kolejności pierwszych wystąpień.
